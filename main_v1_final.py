...
def optimizers(generator, discriminator, learningrate = 2e-4, amsgrad = False, b = 0.9, momentum = 0.9):
    """ Returns an Adam optimizer for the discriminator and an Adam optimizer for the generator
        Using the default value of 0.9 as the value of the first parameter of the betas in Adam.
    """

    Discriminator_optimizer = optim.SGD( discriminator.parameters(), lr = learningrate, momentum = momentum)

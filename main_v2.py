...
def optimizers(generator, discriminator, learningrate = 2e-4, amsgrad=False, b=0.5, momentum=0.9):
    ...
    Discriminator_optimizer = optim.SGD( discriminator.parameters(), lr = learningrate * 2, weight_decay = 1e-4, momentum = momentum)
...
def GAN_training():
    ...
    generator = generator = GeneratorWithSkipConnections().to(device)
    ...
    # the weights of the network can be updated.
